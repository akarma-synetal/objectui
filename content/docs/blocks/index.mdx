...
<SchemaExample id="blocks-gallery/block-gallery-stats-card" />

<SchemaExample id="blocks-gallery/block-gallery-login-card" />

<SchemaExample id="blocks-gallery/block-gallery-notification-item" />
