...
const fr = {
  ...
  report: {
    ...
    editor: {
      ...
      filtersComplex:
        'This report uses an advanced filter that cannot be edited here. Save will keep it unchanged.',
      groupBy: 'Group by',
      ...
      validationMatrixNeedsRowsCols:
        'Matrix reports need at least one Row and one Column.',
      validationSummaryNeedsRows:
        'Summary reports need at least one grouping field.',
      noneOption: '(none)',
    },
  },
} as const;
